...
var TextBase = (function (_super) {
    ...
    TextBase.prototype[text_base_common_2.lineHeightProperty.getDefault] = function () {
        return this.nativeTextViewProtected.getLineHeight() / text_base_common_2.layout.getDisplayDensity();
    };
    TextBase.prototype[text_base_common_2.lineHeightProperty.setNative] = function (value) {
        var fontHeight = this.nativeTextViewProtected.getPaint().getFontMetricsInt(null);
        this.nativeTextViewProtected.setLineSpacing(Math.max(value - fontHeight, 0) * text_base_common_2.layout.getDisplayDensity(), 1);
    };
...
var BaselineAdjustedSpan = (function (_super) {
    __extends(BaselineAdjustedSpan, _super);
    function BaselineAdjustedSpan(fontSize, align) {
        var _this = _super.call(this) || this;
    ...
    BaselineAdjustedSpan.prototype.updateDrawState = function (paint) {
        this.updateState(paint);
    };
    BaselineAdjustedSpan.prototype.updateMeasureState = function (paint) {
        this.updateState(paint);
    };
    BaselineAdjustedSpan.prototype.updateState = function (paint) {
