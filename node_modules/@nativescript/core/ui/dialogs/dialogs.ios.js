...
function showUIAlertController(alertController) {
    var _a, _b;
    var viewController = application_1.ios.rootController;
    while (viewController && viewController.presentedViewController) {
        viewController = viewController.presentedViewController;
    }
    if (!viewController) {
        view_1.traceWrite("No root controller found to open dialog.", view_1.traceCategories.Error, view_1.traceMessageType.warn);
        return;
    }
