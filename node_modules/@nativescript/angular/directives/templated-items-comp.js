...
TemplatedItemsComponent.ɵfac = function TemplatedItemsComponent_Factory(t) { ɵngcc0.ɵɵinvalidFactory(); };
TemplatedItemsComponent.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: TemplatedItemsComponent, contentQueries: function TemplatedItemsComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, core_1.TemplateRef, true, core_1.TemplateRef);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.itemTemplateQuery = _t.first);
    } }, viewQuery: function TemplatedItemsComponent_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(_c0, true, core_1.ViewContainerRef);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.loader = _t.first);
    } }, inputs: { items: "items" }, outputs: { setupItemView: "setupItemView" } });
...
var TemplateKeyDirective = /** @class */ (function () {
    ...
    TemplateKeyDirective = __decorate([ __param(1, core_1.Inject(exports.TEMPLATED_ITEMS_COMPONENT)), __param(1, core_1.Host()),
        __metadata("design:paramtypes", [core_1.TemplateRef,
            TemplatedItemsComponent])
    ], TemplateKeyDirective);
TemplateKeyDirective.ɵfac = function TemplateKeyDirective_Factory(t) { return new (t || TemplateKeyDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.TemplateRef), ɵngcc0.ɵɵdirectiveInject(exports.TEMPLATED_ITEMS_COMPONENT, 1)); };
TemplateKeyDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: TemplateKeyDirective, selectors: [["", "nsTemplateKey", ""]], inputs: { nsTemplateKey: "nsTemplateKey" } });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(TemplateKeyDirective, [{
        type: core_1.Directive,
        args: [{ selector: "[nsTemplateKey]" }]
    }], function () { return [{ type: ɵngcc0.TemplateRef }, { type: TemplatedItemsComponent, decorators: [{
                type: core_1.Inject,
                args: [exports.TEMPLATED_ITEMS_COMPONENT]
            }, {
                type: core_1.Host
            }] }]; }, { nsTemplateKey: [{
            type: core_1.Input
