...
var TabViewDirective = /** @class */ (function () {
    ...
    TabViewDirective = __decorate([ __metadata("design:paramtypes", [core_1.ElementRef])
    ], TabViewDirective);
TabViewDirective.ɵfac = function TabViewDirective_Factory(t) { return new (t || TabViewDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef)); };
TabViewDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: TabViewDirective, selectors: [["TabView"]], inputs: { selectedIndex: "selectedIndex" } });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(TabViewDirective, [{
        type: core_1.Directive,
        args: [{
                selector: "TabView"
            }]
    }], function () { return [{ type: ɵngcc0.ElementRef }]; }, { selectedIndex: [{
            type: core_1.Input
        }] }); })();
...
var TabViewItemDirective = /** @class */ (function () {
    ...
    TabViewItemDirective = __decorate([ __metadata("design:paramtypes", [TabViewDirective,
            core_1.TemplateRef,
            core_1.ViewContainerRef])
    ], TabViewItemDirective);
TabViewItemDirective.ɵfac = function TabViewItemDirective_Factory(t) { return new (t || TabViewItemDirective)(ɵngcc0.ɵɵdirectiveInject(TabViewDirective), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.TemplateRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ViewContainerRef)); };
TabViewItemDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: TabViewItemDirective, selectors: [["", "tabItem", ""]], inputs: { config: ["tabItem", "config"], title: "title", iconSource: "iconSource", textTransform: "textTransform" } });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(TabViewItemDirective, [{
        type: core_1.Directive,
        args: [{
                selector: "[tabItem]" // tslint:disable-line:directive-selector
            }]
    }], function () { return [{ type: TabViewDirective }, { type: ɵngcc0.TemplateRef }, { type: ɵngcc0.ViewContainerRef }]; }, { config: [{
            type: core_1.Input,
            args: ["tabItem"]
        }], title: [{
            type: core_1.Input
