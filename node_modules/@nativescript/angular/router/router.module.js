...
exports.NSRouterLink = ns_router_link_1.NSRouterLink;
var ns_router_link_active_1 = require("./ns-router-link-active");
exports.NSRouterLinkActive = ns_router_link_active_1.NSRouterLinkActive;
var page_router_outlet_1 = require("./page-router-outlet");
exports.PageRouterOutlet = page_router_outlet_1.PageRouterOutlet;
var ns_location_strategy_1 = require("./ns-location-strategy");
exports.NSLocationStrategy = ns_location_strategy_1.NSLocationStrategy;
...
exports.NSEmptyOutletComponent = ns_empty_outlet_component_1.NSEmptyOutletComponent;
...
var ɵngcc1 = require('@angular/router');
var ɵngcc2 = require('./ns-router-link');
var ɵngcc3 = require('./ns-router-link-active');
var ɵngcc4 = require('./page-router-outlet');
var ɵngcc5 = require('./ns-empty-outlet.component');
var ɵngcc6 = require('../common');
var NativeScriptRouterModule = /** @class */ (function () {
    ...
    NativeScriptRouterModule.forRoot = function (routes, config) {
        return {
            ...
            providers: __spreadArrays(router_1.RouterModule.forRoot(routes, config).providers, [
                {
...
NativeScriptRouterModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: NativeScriptRouterModule });
NativeScriptRouterModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function NativeScriptRouterModule_Factory(t) { return new (t || NativeScriptRouterModule)(); }, imports: [[router_1.RouterModule, common_2.NativeScriptCommonModule], ɵngcc1.RouterModule] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NativeScriptRouterModule, { declarations: [ɵngcc2.NSRouterLink, ɵngcc3.NSRouterLinkActive, ɵngcc4.PageRouterOutlet, ɵngcc5.NSEmptyOutletComponent], imports: [ɵngcc1.RouterModule, ɵngcc6.NativeScriptCommonModule], exports: [ɵngcc1.RouterModule, ɵngcc2.NSRouterLink, ɵngcc3.NSRouterLinkActive, ɵngcc4.PageRouterOutlet, ɵngcc5.NSEmptyOutletComponent] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NativeScriptRouterModule, [{
        type: core_1.NgModule,
        args: [{
                declarations: [
                    ns_router_link_1.NSRouterLink, ns_router_link_active_1.NSRouterLinkActive, page_router_outlet_1.PageRouterOutlet, ns_empty_outlet_component_1.NSEmptyOutletComponent
                ],
