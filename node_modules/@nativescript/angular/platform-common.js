...
var text_view_1 = require("@nativescript/core/ui/text-view");
...
var application_2 = require("@nativescript/core/application");
...
var NativeScriptPlatformRef = /** @class */ (function (_super) {
    ...
    NativeScriptPlatformRef.prototype.bootstrapApp = function () {
        ...
        if (this.appOptions && typeof this.appOptions.cssFile === "string") {
            application_2.setCssFileName(this.appOptions.cssFile);
        }
    ...
    NativeScriptPlatformRef.prototype.bootstrapNativeScriptApp = function () {
        ...
        var launchCallback = profiling_1.profile("nativescript-angular/platform-common.launchCallback", function (args) {
            ...
            var tempAppHostView;
            if (autoCreateFrame) {
                var _a = _this.createFrameAndPage(false), page = _a.page, frame = _a.frame;
        ...
        var exitCallback = profiling_1.profile("nativescript-angular/platform-common.exitCallback", function (args) {
        ...
        application_2.on(application_2.launchEvent, launchCallback);
        application_2.on(application_2.exitEvent, exitCallback);
        application_2.run();
    };
